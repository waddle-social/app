...
- [ ] Add `EventBus` tests for routing correctness, glob filtering, per-domain ordering, correlation ID tracking, and lagged subscriber recovery behaviour.
